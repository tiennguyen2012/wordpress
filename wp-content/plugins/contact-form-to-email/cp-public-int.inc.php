...
<?php } ?>
<input type="submit" class="submit" name="<?php echo $this->prefix; ?>_subbtn" id="<?php echo $this->prefix; ?>_subbtn" value="<?php _e("Submit"); ?>">
</form>